...
class RequireRegister3Dialog : DialogFragment() {

    var onOkClickListener: (() -> Unit)? = null
    var timeoutCallback: (() -> Unit)? = null

    companion object {
        fun newInstance(): RequireRegister3Dialog = RequireRegister3Dialog().apply { }
    }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.dialog_confirm_register_pudo, container, false)
    }
