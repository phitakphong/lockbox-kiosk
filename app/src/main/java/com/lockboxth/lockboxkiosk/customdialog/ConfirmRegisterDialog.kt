...
class ConfirmRegisterDialog : DialogFragment() {

    var onOkClickListener: (() -> Unit)? = null
    var timeoutCallback: (() -> Unit)? = null
    var onCancelClickListener: (() -> Unit)? = null

    var layoutId = R.layout.dialog_confirm_register_pudo

    companion object {
        fun newInstance(resId: Int = R.layout.dialog_confirm_register_pudo): ConfirmRegisterDialog = ConfirmRegisterDialog().apply {
            layoutId = resId
        }
    }
