...
import kotlinx.android.synthetic.main.dialog_invalid_qr.*

class InvalidQrDialog : DialogFragment() {
    ...
    companion object {
        fun newInstance(message: String? = null): InvalidQrDialog = InvalidQrDialog().apply {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.dialog_invalid_qr, container, false)
    }
