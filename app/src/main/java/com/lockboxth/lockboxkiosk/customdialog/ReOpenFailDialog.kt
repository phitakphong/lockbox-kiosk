...
class ReOpenFailDialog : DialogFragment() {
    ...
    companion object {
        fun newInstance(message: String): ReOpenFailDialog = ReOpenFailDialog().apply {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.dialog_re_open_fail, container, false)
    }
