...
class RequireRegisterDialog : DialogFragment() {

    var onOkClickListener: (() -> Unit)? = null
    var timeoutCallback: (() -> Unit)? = null

    companion object {
        fun newInstance(): RequireRegisterDialog = RequireRegisterDialog().apply { }
    }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.dialog_require_register, container, false)
    }
